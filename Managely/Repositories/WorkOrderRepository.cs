...
namespace Managely.Repositories
{
    public class WorkOrderRepository : BaseRepository, IWorkOrderRepository
    {
        ...
        public List<WorkOrder> GetTenantOpenWorkOrders(int userProfileId)
        {
            using (SqlConnection conn = Connection)
            {
                conn.Open();
        ...
        public List<WorkOrder> GetTenantCompletedWorkOrders(int userProfileId)
        {
            using (SqlConnection conn = Connection)
            {
                conn.Open();
        ...
        public List<WorkOrder> GetAllOpen()
        {   
            using (SqlConnection conn = Connection)
            {
                conn.Open();
        ...
        public List<WorkOrder> GetAllCompleted()
        {
            using (SqlConnection conn = Connection)
            {
                conn.Open();
